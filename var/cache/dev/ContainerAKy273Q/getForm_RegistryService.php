...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\RegisterClassroomType' => function () {
    return ($this->privates['App\Form\RegisterClassroomType'] ?? $this->privates['App\Form\RegisterClassroomType'] = new \App\Form\RegisterClassroomType());
}, 'App\\Form\\RegisterCompetenceType' => function () {
    return ($this->privates['App\Form\RegisterCompetenceType'] ?? $this->privates['App\Form\RegisterCompetenceType'] = new \App\Form\RegisterCompetenceType());
}, 'App\\Form\\RegisterDomaineType' => function () {
    return ($this->privates['App\Form\RegisterDomaineType'] ?? $this->privates['App\Form\RegisterDomaineType'] = new \App\Form\RegisterDomaineType());
}, 'App\\Form\\RegisterStudentType' => function () {
    return ($this->privates['App\Form\RegisterStudentType'] ?? $this->privates['App\Form\RegisterStudentType'] = new \App\Form\RegisterStudentType());
}, 'App\\Form\\RegisterTeacherType' => function () {
    return ($this->privates['App\Form\RegisterTeacherType'] ?? $this->privates['App\Form\RegisterTeacherType'] = new \App\Form\RegisterTeacherType());
...
}, 'App\\Form\\ResettingType' => function () {
    return ($this->privates['App\Form\ResettingType'] ?? $this->privates['App\Form\ResettingType'] = new \App\Form\ResettingType());
