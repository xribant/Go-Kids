...
// Returns the private 'App\Repository\RegisterUserRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/RegisterUserRepository.php';

return $this->privates['App\Repository\RegisterUserRepository'] = new \App\Repository\RegisterUserRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
