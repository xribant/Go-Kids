...
$b->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\ClassroomRepository' => function () {
    return ($this->privates['App\Repository\ClassroomRepository'] ?? $this->load('getClassroomRepositoryService.php'));
}, 'App\\Repository\\CompetenceRepository' => function () {
    return ($this->privates['App\Repository\CompetenceRepository'] ?? $this->load('getCompetenceRepositoryService.php'));
}, 'App\\Repository\\ControleRepository' => function () {
    return ($this->privates['App\Repository\ControleRepository'] ?? $this->load('getControleRepositoryService.php'));
}, 'App\\Repository\\DomaineRepository' => function () {
    return ($this->privates['App\Repository\DomaineRepository'] ?? $this->load('getDomaineRepositoryService.php'));
}, 'App\\Repository\\RegisterUserRepository' => function () {
    return ($this->privates['App\Repository\RegisterUserRepository'] ?? $this->load('getRegisterUserRepositoryService.php'));
