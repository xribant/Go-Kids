...
// Returns the private 'App\Repository\ControleRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ControleRepository.php';

return $this->privates['App\Repository\ControleRepository'] = new \App\Repository\ControleRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
