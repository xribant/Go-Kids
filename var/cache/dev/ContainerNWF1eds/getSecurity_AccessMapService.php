...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/renew-password'), array(0 => 'IS_AUTHENTICATED_ANONYMOUSLY'), NULL);
...
$instance->add($a, array(0 => 'ROLE_ADMIN', 1 => 'ROLE_USER'), NULL);
