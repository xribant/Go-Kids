...
class __TwigTemplate_ea03e19568e00e37861f96be825066c80b3bf297038e4c97981792099da07460 extends Twig_Template
{
    private $source;
    ...
    public function block_form_errors($context, array $blocks = array())
    {
        ...
        // line 4
        echo "        ";
        if ((twig_length_filter($this->env, (isset($context["errors"]) || array_key_exists("errors", $context) ? $context["errors"] : (function () { throw new Twig_Error_Runtime('Variable "errors" does not exist.', 4, $this->source); })())) > 0)) {
            // line 5
            echo "        \t<div class=\"alert alert-danger\" role=\"alert\">
\t            ";
            // line 6
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable((isset($context["errors"]) || array_key_exists("errors", $context) ? $context["errors"] : (function () { throw new Twig_Error_Runtime('Variable "errors" does not exist.', 6, $this->source); })()));
...
\t            ";
    ...
    {
        return array (  74 => 11,  70 => 9,  61 => 7,  57 => 6,  54 => 5,  51 => 4,  48 => 3,  30 => 2,);
    }

    public function getSourceContext()
    {
        return new Twig_Source("{# form_errors.html.twig #}
{% block form_errors %}
    {% spaceless %}
        {% if errors|length > 0 %}
...
\t        </div>
        {% endif %}
    {% endspaceless %}
{% endblock form_errors %}", "form/form_errors.html.twig", "/Users/ribantxa/Sites/go-kids.be/templates/form/form_errors.html.twig");
    }
}
