...
/**
 * @ORM\Entity
 * @UniqueEntity("name", message="Une autre classe avec ce nom existe déjà")
 */
class Classroom
{
    /**
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Teacher", mappedBy="classrooms" )
     */
    private $teachers;
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Controle", mappedBy="classroom")
     */
    private $controles;
